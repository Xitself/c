...
local nexus = loadstring(game:HttpGet("https://github.com/raditself/c/releases/download/x/xPip.txt"))()
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/raditself/c/main/BetterSaveManager"))()
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/raditself/c/main/BetterInterfaceManager1"))()
    ...
    Callback = function(value)
        ...
        Players.LocalPlayer.OnTeleport:Connect(function(State)
            if KeepNexus and (not TeleportCheck) and queueteleport then
                TeleportCheck = true
                queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/raditself/c/main/loadstring'))()")
            end
        end)
    end 
})
...
-- Adding another highlight for better vision
